<?php
	...
	$header_logo_sticky = get_theme_mod( 'header_logo_sticky', '' );
				...
				<div class="nav-bar site-header">
					<div class="container align-mid">
						...
						<div class="col-md-2 text-left">
							...
							<!-- Site Title and Logo -->
							<?php if( get_theme_mod( 'show_header_sticky_logo', true ) == true ) : ?>
								<div class="header-title">
									<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="header-logo">
										<?php if( $header_logo_sticky !== '' ) : ?>
											<img src="<?php echo esc_url( $header_logo_sticky ); ?>" class="header-logo-img" alt="<?php esc_attr(bloginfo( 'name' )); ?>" />
										<?php else : ?>
